    ...
    return (
      <div className={styles.container}>
        <div className={`${styles.galleryContainer} ${styles.w2} ${styles.h2}`}>
          <div className={styles.galleryItem}>
            <div className={styles.image}>
              <img onClick={this.photoClickHandlerA} src={this.props.photos[0].image_url} />
            </div>
          </div>
        </div>
        <div className={styles.galleryContainer}>
          <div className={styles.galleryItem}>
            <div className={styles.image}>
              <img onClick={this.photoClickHandlerB} src={this.props.photos[1].image_url} />
            </div>
          </div>
        </div>
        <div className={styles.galleryContainer}>
          <div className={styles.galleryItem}>
            <div className={styles.image}>
              <img onClick={this.photoClickHandlerC} src={this.props.photos[2].image_url} />
            </div>
          </div>
        </div>
        <div className={styles.galleryContainer}>
          <div className={styles.galleryItem}>
            <div className={styles.image}>
              <img onClick={this.photoClickHandlerD} src={this.props.photos[3].image_url} />
            </div>
          </div>
        </div>
        <div className={styles.galleryContainer}>
          <div className={styles.galleryItem}>
            <div className={styles.image}>
              <img onClick={this.photoClickHandlerE} src={this.props.photos[4].image_url} />
            </div>
          </div>
